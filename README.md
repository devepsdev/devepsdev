...
Desarrollador Full Stack & DevOps con triple formación técnica (ASIR + DAM + DAW) y aplicaciones desplegadas en producción en infraestructura propia.

## 🚀 Proyectos en producción

| Proyecto | Stack | Descripción | Enlaces |
|----------|-------|-------------|---------|
| **Pedidoo** | Spring Boot 3.5 · Angular 19 · TypeScript · IA · MCP · n8n · Docker · MySQL · JWT · JUnit | Plataforma B2B para gestión de proveedores, productos y pedidos con IA integrada. +40 tests | [Web](https://deveps.ddns.net/pedidoo) · [API Docs](https://deveps.ddns.net/pedidoo/swagger-ui/index.html) · [Repo](https://github.com/devepsdev/pedidoo) |
...
**Backend:** Java · Spring Boot · Django · Node.js · Express · Python  
**Frontend:** Angular · React · Next.js · TypeScript · Tailwind CSS · Bootstrap  
**Bases de datos:** MySQL · PostgreSQL · MongoDB  
**DevOps:** Docker · Linux · Apache · Git · GitHub Actions CI/CD · SSL  
**Automation IA:* MCP · n8n · Claude Code
**Testing:** JUnit · Swagger/OpenAPI  

## 📫 Contacto

[![Portfolio](https://img.shields.io/badge/Portfolio-deveps.ddns.net-blue?style=flat-square)](https://deveps.ddns.net)
[![LinkedIn](https://img.shields.io/badge/LinkedIn-Enrique_Pérez-0A66C2?style=flat-square&logo=linkedin)](https://linkedin.com/in/enrique-perez-sanchez)
[![Email](https://img.shields.io/badge/Email-devepsdev@gmail.com-EA4335?style=flat-square&logo=gmail)](mailto:devepsdev@gmail.com)
